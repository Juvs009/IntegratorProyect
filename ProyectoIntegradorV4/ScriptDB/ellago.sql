...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2022 a las 19:14:34
...
--
-- Base de datos: `ellago`
--
CREATE DATABASE IF NOT EXISTS `ellago` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
USE `ellago`;
