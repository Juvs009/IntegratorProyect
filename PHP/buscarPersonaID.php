...
if(isset($parameters)){
	...
	if(JSONCorrectoEliminar($mensajeRecibido)){

		$persona = $mensajeRecibido; 
		...
		$persona2 = $result->fetch_assoc ();
		
		if (isset ( $result ) && $persona2) { // Si pasa por este if, la query está está bien y se ha insertado correctamente
			
			$arrMensaje["estado"] = "ok";
			$arrMensaje["persona"] = $persona2;
